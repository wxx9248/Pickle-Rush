...
class GameWin(Scene):
    def __init__(self, size: typing.Tuple[int, int], next_level_scene: typing.Optional[typing.Type[Scene]]):
        ...
        game_win_text_atlas.position_x = util.center(self.size, game_win_text_sprite.surface.get_size())[0] - 20
        ...
        next_level_text_atlas.position = util.center(self.size, next_level_text_sprite.surface.get_size())[0] + 90
