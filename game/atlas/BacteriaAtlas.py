...
from game.atlas.TileAtlas import TileType
...
class BacteriaAtlas(Atlas):
    ...
    def get_grid_pos(self) -> Tuple[int, int]:
        return self.__map_obj.actual_pos_to_grid_pos(pygame.Vector2(self.position))
    ...
    def move_to_next_pos(self) -> None:
        ...
        block_size = self.__scene.map_obj.block_size
    ...
    def a_star_search(self) -> Dict[Tuple[int, int], Tuple[int, int]]:
        ...
        start = self.__map_obj.actual_pos_to_grid_pos(pygame.Vector2(self.position))
        goal = self.__map_obj.actual_pos_to_grid_pos(
