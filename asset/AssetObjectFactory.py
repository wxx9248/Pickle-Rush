...
class AssetObjectFactory:
    ...
    ASSET_PROPS = {
        ...
        "asset/images/level-1-bg.png": {"key": "asset.sprite.level.1.background"},
        "asset/images/tower.png": {"key": "asset.sprite.tower"},
        "asset/images/tree.png": {"key": "asset.sprite.tree"},
        "asset/images/tiles/grass.png": {"key": "asset.sprite.tile.grass"},
        "asset/images/tiles/soil.png": {"key": "asset.sprite.tile.soil"},
        "asset/images/tiles/water.png": {"key": "asset.sprite.tile.water"},
